...
namespace Chet.WebApi.Template.GUI.Domain.Exceptions
{
    /// <summary>
    /// 下载源码异常
    /// <para>用于表示源代码下载过程中发生的错误</para>
    /// </summary>
    public class DownSourceCodeException : Exception
    {
        /// <summary>
        /// 初始化<see cref="DownSourceCodeException"/>类的新实例
        /// </summary>
        ...
        /// <summary>
        /// 使用指定的错误消息初始化<see cref="DownSourceCodeException"/>类的新实例
        /// </summary>
        ...
        /// <summary>
        /// 使用指定的错误消息和对作为此异常原因的内部异常的引用来初始化<see cref="DownSourceCodeException"/>类的新实例
        /// </summary>
        /// <param name="message">描述错误的消息</param>
        ...
        /// <summary>
        /// 用序列化数据初始化<see cref="DownSourceCodeException"/>类的新实例
        /// </summary>
